...
void main() {
    ...
    openSea.getCollections("", "100", "5").then((value){
      ...
      if(collections != null){
        ...
        for (var element in collections) {print(element);}
      }
    });
    ...
    openSea.getAssets("",null,null,null,OrderBy.saleDate,OrderDirection.asc,"1","1","doodles-official").then((value){
       List<asset_object.Assets>? assets = value.assets;
       if(assets != null){
           for (var element in assets) {print(element.lastSale);}
       }
